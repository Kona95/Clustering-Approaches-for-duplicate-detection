...
import com.damirvandic.sparker.Birch.BirchClustering;
import com.damirvandic.sparker.Clarans.ClaransClustering;
import com.damirvandic.sparker.Cure.CureClustering;
...
public class Algorithms {
    public static class PerfectMSMClustering implements AlgorithmFactory {
        ...
        public Algorithm build(String cachingPath, Map<String, String> hadoopConfig) {
            return new MsmBasedAlgorithm("perf.msms", new MsmClusteringProcedure(), cachingPath, hadoopConfig, new AllPairsScheme(), null);
        }
    }

    public static class CureBasedClustering implements AlgorithmFactory {
        @Override
        public Algorithm build(String cachingPath, Map<String, String> hadoopConfig) {
            return new MsmBasedAlgorithm("cure", new CureClustering(), cachingPath, hadoopConfig, new AllPairsScheme(), null);
        }
    }
    public static class CureBasedClusteringP implements AlgorithmFactory {
        @Override
        public Algorithm build(String cachingPath, Map<String, String> hadoopConfig) {
            return new MsmBasedAlgorithm("cure", new CureClustering(), cachingPath, hadoopConfig, new AllPairsScheme(), new PerfectSimilarity());
        }
    }

    public static class BirchBasedClustering implements AlgorithmFactory {
        @Override
        public Algorithm build(String cachingPath, Map<String, String> hadoopConfig) {
            return new MsmBasedAlgorithm("birch", new BirchClustering(), cachingPath, hadoopConfig, new AllPairsScheme(), null);
        }
    }

    public static class ClaransBasedClustering implements AlgorithmFactory {
        @Override
        public Algorithm build(String cachingPath, Map<String, String> hadoopConfig) {
            return new MsmBasedAlgorithm("clarans", new ClaransClustering(), cachingPath, hadoopConfig, new AllPairsScheme(), null);
        }
    }
