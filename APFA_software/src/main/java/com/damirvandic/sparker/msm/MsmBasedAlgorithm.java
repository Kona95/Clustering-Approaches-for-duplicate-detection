...
public class MsmBasedAlgorithm extends JavaAlgorithm {
    ...
    public synchronized Clusters computeClusters(Map<String, Object> conf, Set<ProductDesc> data) {
        ...
        //TODO: it was final boolean shopHeuristic = (boolean) conf.get("shopHeuristic"); change to get or else
        final boolean shopHeuristic = (boolean) conf.getOrDefault("shopHeuristic",true);
